class Series
  ...
  SERIES = {
    ...
    'nonogram-5' => { source: 'nonograms', first_puzzle: 1, last_puzzle: 99_999_999,
                      size: 5, display_name: '5x5 Nonograms' },
    'nonogram-10' => { source: 'nonograms', first_puzzle: 1, last_puzzle: 99_999_999,
                       size: 10, display_name: '10x10 Nonograms' },
    'nonogram-15' => { source: 'nonograms', first_puzzle: 1, last_puzzle: 99_999_999,
                       size: 15, display_name: '15x15 Nonograms' },
    'nonogram-20' => { source: 'nonograms', first_puzzle: 1, last_puzzle: 99_999_999,
                       size: 20, display_name: '20x20 Nonograms' },
    'nonogram-25' => { source: 'nonograms', first_puzzle: 1, last_puzzle: 99_999_999,
